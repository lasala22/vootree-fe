...
const PartnerProfile = () => {
  ...
  return (
    <div className="flex justify-center items-center  min-h-fit max-w-full py-10 ">
      <div className="p-8 bg-white rounded-lg shadow-lg w-full max-w-7xl">
        <Tabs defaultActiveKey="1">
          <TabPane tab="Personal Information" key="1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div></div>
              <Flex className=" flex justify-center" gap="middle" wrap>
                <Upload
                  name="avatar"
                ...
                >
                  {imageUrl ? (
                    <img
                      ...
                      alt="avatar"
                      style={{
                        maxWidth: "150px", // Thay đổi kích thước width theo ý bạ
                      }}
                    />
                  ) : (
                    uploadButton
          ...
          <TabPane tab="Change Password" key="4">
            ...
            <Form layout="vertical" onFinish={ChangePass}>
              <Form.Item
